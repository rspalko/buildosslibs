  ...
  kdws_url_dialog::OnInitDialog()
{
  ...
  bool use_cache = settings->get_jpip_use_cache();
  ...
  use_cache_button()->SetCheck((use_cache)?BST_CHECKED:BST_UNCHECKED);
  ...
  kdws_url_dialog::OnOK()
{
  ...
  bool use_cache =
    (use_cache_button()->GetCheck() == BST_CHECKED);
  settings->set_jpip_use_cache(use_cache);
