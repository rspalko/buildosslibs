...
// NB: this is a simple way to keep these definitions out of the public
// header file, where they are a distraction.  We could create an extra
// local header file in the usual way but Kakadu has enough files as is ...
...
kdu_roi_rect::~kdu_roi_rect()
{
  if (comp_regions != NULL)
    delete[] comp_regions;
}

/*****************************************************************************/
/*                          kdu_roi_rect::acquire_node                       */
/*****************************************************************************/

kdu_roi_node *kdu_roi_rect::acquire_node(int comp_idx,
                                         kdu_core::kdu_dims tile_region)
{  
