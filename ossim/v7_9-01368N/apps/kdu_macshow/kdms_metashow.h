...
-(void)activateWithSource:(jp2_family_src *)source;
      // After calling this function, do the following: 1) if there is a JPX
      // data source, invoke `jpx_source::load_matches(-1,NULL,-1,NULL)';
      // 2) `update_metadata' function below immediately
-(void)update_metadata;
      // Before calling this function, if the source of data is a JPX data
      // source, you should be sure to call
      // `jpx_source::load_matches(-1,NULL,-1,NULL)' to load everything.
