...
class _aux_delegator__kdu_region_compositor {
  public:
    ...
    virtual bool custom_paint_overlay(kdu_compositor_buf *buffer, kdu_dims buffer_region, kdu_dims bounding_region, jpx_metanode node, kdu_overlay_params *painting_params, kdu_coords image_offset, kdu_coords subsampling, bool transpose, bool vflip, bool hflip, kdu_coords expansion_numerator, kdu_coords expansion_denominator, kdu_coords compositing_offset, kdu_colour_order colour_order) { return (bool) 0; }
...
class _aux_extended__kdu_region_compositor : public kdu_region_compositor {
  ...
  public:
    ...
    virtual bool  custom_paint_overlay(kdu_compositor_buf *buffer, kdu_dims buffer_region, kdu_dims bounding_region, jpx_metanode node, kdu_overlay_params *painting_params, kdu_coords image_offset, kdu_coords subsampling, bool transpose, bool vflip, bool hflip, kdu_coords expansion_numerator, kdu_coords expansion_denominator, kdu_coords compositing_offset, kdu_colour_order colour_order)
      { return _delegator->custom_paint_overlay(buffer,buffer_region,bounding_region,node,painting_params,image_offset,subsampling,transpose,vflip,hflip,expansion_numerator,expansion_denominator,compositing_offset,colour_order); }
