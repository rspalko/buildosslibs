...
clinical specialist).
   Note: Although the definitions found in this file may be useful for
other projects, we make no attempt to given them their own namespace here.
That would be something you might do in creating a more comprehensive
set of ROI source interfaces with separate implementation files.  This
header file, as it stands, exists only to improve the readability of
the stand-alone "kdu_compress" demo-app.
******************************************************************************/
...
class kdu_roi_rect : public kdu_roi_image {
  ...
  */
  public: // Member functions
    KDU_AUX_EXPORT kdu_roi_rect(kdu_codestream codestream, kdu_dims region);
      /* [SYNOPSIS]
      ...
      */
    KDU_AUX_EXPORT ~kdu_roi_rect();
    kdu_roi_node *acquire_node(int comp_idx, kdu_dims tile_region);
      /* [BIND: no-bind]
         [SYNOPSIS]
           See the description of `kdu_roi_image::acquire_node'.
      */
  private: // Data
    int num_components;
...
class kdu_roi_graphics : public kdu_roi_image {
  ...
  */
  public: // Member functions
    KDU_AUX_EXPORT kdu_roi_graphics(kdu_codestream codestream,
                                    const char *fname, float threshold);
      /* [SYNOPSIS]
      ...
      */
    KDU_AUX_EXPORT ~kdu_roi_graphics();
    kdu_roi_node *acquire_node(int comp_idx, kdu_dims tile_region);
      /* [BIND: no-bind]
         [SYNOPSIS]
           See the description of `kdu_roi_image::acquire_node'.
