...
class kdu_push_pull_params {
  /* [SYNOPSIS]
       Instances of this class do nothing in this version of the Kakadu
       software, but may do so in the future or in other versions of
       Kakadu.  You can construct, destruct and copy insances of this
       class, but do nothing else here.
  */
  public:
    kdu_push_pull_params() { state=NULL; };
  private:
    void *state;
  };
    ...
    KDU_EXPORT kdu_long
      ...
      /* [SYNOPSIS]
         ...
         [ARG: external_sample_allocator]
           ...
           `kdu_sample_allocator::reset' and `kdu_sample_allocator::finalize'.
           [//]
           The `destroy' function will not delete any memory retained within
           an `external_sample_allocator' supplied here.
         [ARG: extra_params]
           This reserved argument has no impact on this version of Kakadu.
      */
    kdu_long
      create(kdu_codestream codestream, kdu_tile tile,
