...
#define KDU_TIFFTAG_Icc                ((kdu_uint32) 0x87730007)
    ...
    public: // Member functions
      ...
      KDU_AUX_EXPORT kdu_uint32 open_tag(kdu_uint32 tag_type);
        /* [SYNOPSIS]
           ...
           [RETURNS]
             0 if the tag does not exist; otherwise, the actual tag-type
             code is returned.
           [ARG: tag_type]
             See the introductory comments to this `kdu_tiffdir' object for
      ...
      KDU_AUX_EXPORT void create_tag(kdu_uint32 tag_type);
        ...
        */
      KDU_AUX_EXPORT void
        write_tag(kdu_uint32 tag_type, int length, const kdu_byte data[]);
        /* [SYNOPSIS]
        ...
        */
      KDU_AUX_EXPORT void
        write_tag(kdu_uint32 tag_type, int length, const kdu_uint16 data[]);
        /* [SYNOPSIS]
        ...
        */
      KDU_AUX_EXPORT void
        write_tag(kdu_uint32 tag_type, int length, const kdu_uint32 data[]);
        /* [SYNOPSIS]
           [BIND: no-bind]
        ...
        */
      KDU_AUX_EXPORT void
        write_tag(kdu_uint32 tag_type, int length, const double data[]);
        /* [SYNOPSIS]
             Same as the second form of `write_tag', except that this function
             may be used only with tags whose data type (least significant
             two bytes of the `tag_type') is one of 5, 10, 11 or 12.  These
        ...
        */
      KDU_AUX_EXPORT void
        write_tag(kdu_uint32 tag_type, int length, const kdu_long data[]);
        /* [SYNOPSIS]
             Same as the second form of `write_tag', except that this function
