...
void
  kdu_core::kdu_customize_warnings(kdu_message *handler)
{
...
void
  kdu_core::kdu_customize_errors(kdu_message *handler)
{
  err_handler = handler;
}
...
void
  kdu_core::kdu_customize_text(const char *context, kdu_uint32 id,
                               const char *lead_in, const char *text)
{
...
void
  kdu_core::kdu_customize_text(const char *context, kdu_uint32 id,
                               const kdu_uint16 *lead_in,
                               const kdu_uint16 *text)
{
  text_register.add(context,id,lead_in,text);
}
...
/*****************************************************************************/
/*                    kdu_message_queue::kdu_message_queue                   */
/*****************************************************************************/

kdu_message_queue::kdu_message_queue()
{
  throw_exceptions = false;
  exception_val = KDU_NULL_EXCEPTION;
  auto_pop = false;
  max_elts = 10;
  num_elts = 0;
...
/*****************************************************************************/
/*                       kdu_message_queue::start_message                    */
/*****************************************************************************/

void kdu_message_queue::start_message()
{
...
/*****************************************************************************/
/*                        kdu_message_queue::pop_message                     */
/*****************************************************************************/

const char *kdu_message_queue::pop_message()
{
  mutex.lock();
...
kdu_message_formatter::kdu_message_formatter(kdu_message *output, int max_line)
{
...
kdu_error::~kdu_error()
{
  ...
  abort(); // Just in case we did not terminate properly for some reason
}
#ifdef _MSC_VER
