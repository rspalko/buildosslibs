  ...
  */
  public: // Member functions
    ...
    virtual ~kdu_message()
      ...
      noexcept(false) /* ~kdu_error often throws exceptions and this is safe */
#endif
      { return; };
    ...
    kdu_message &operator<<(kdu_long val)
      { // Conveniently prints in decimal with thousands separated by commas
        if (val < 0)
          { (*this)<<'-'; val = -val; }
        kdu_long base = 1;
        while ((base <= (KDU_LONG_MAX/1000)) && ((1000*base) <= val))
          base *= 1000;
  ...
  public: // Member funcions
    KDU_EXPORT kdu_message_queue();
      /* [SYNOPSIS]
           ...
           after construction.
      */
    KDU_EXPORT virtual ~kdu_message_queue();
    ...
    KDU_EXPORT virtual void put_text(const kdu_uint16 *string);
      ...
      */   
    KDU_EXPORT virtual void start_message();
      /* [SYNOPSIS]
    ...
    virtual void flush(bool end_of_message=false)
      ...
      */
    KDU_EXPORT virtual const char *pop_message();
      /* [SYNOPSIS]
...
class kdu_message_formatter : public kdu_message {
  ...
  */
  public: // Member functions
    KDU_EXPORT kdu_message_formatter(kdu_message *output, int max_line=79);
      /* [SYNOPSIS]
      ...
      */
    KDU_EXPORT ~kdu_message_formatter();
      /* [SYNOPSIS]
    ...
    KDU_EXPORT void put_text(const char *string);
      ...
      */
    void put_text(const kdu_uint16 *string)
