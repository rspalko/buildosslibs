...
#define MQE_PARTIAL_CLEAR (~((kdu_int32)(0xFFFFFFFF<<MQE_PARTIAL_POS)))

#define MQE_MSBS_POS (MQE_PARTIAL_POS+1)
#define MQE_MSBS_CLEAR (~((kdu_int32)(0xFFFFFFFF<<MQE_MSBS_POS)))
...
/* ========================================================================= */
/*          Fast Coding Macros used with `mq_encoder::check_out/in'          */
/* ========================================================================= */
