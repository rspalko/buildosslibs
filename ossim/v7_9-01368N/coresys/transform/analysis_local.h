...
class kd_analysis : public kdu_push_ifc_base {
  public: // Member functions
    ...
    void init(kdu_node node, kdu_sample_allocator *allocator,
              ...
              kdu_thread_queue *queue, int flags);
  ...
  private: // Function pointers to allow SIMD acceleration
    void reset_func_ptrs() { deinterleave_16_func = NULL; }
    union {
      kd_deinterleave_16_func deinterleave_16_func; // For fixed-point & shorts
      kd_deinterleave_32_func deinterleave_32_func; // For floats and ints
    };
