...
static kdl_message_info data[74] = {
  {
    "E(mj2.cpp)", 0,
  ...
  },
  {
    "E(mj2.cpp)", 369235463,
    "Error in Kakadu File Format Support:\n",
    "Attempting to access an MJ2 frame for which no chunk mapping is available in the file!  The file may be corrupt or invalid.\0"
  },
  {
    "W(mj2.cpp)", 0,
...
static bool dummy_val = kdl_register_text(data,74);
