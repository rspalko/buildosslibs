...
static kdl_message_info data[89] = {
  {
    "E(jp2.cpp)", 1,
  ...
  },
  {
    "E(jp2.cpp)", 74,
    "Error in Kakadu File Format Support:\n",
    "Malformed \"channel definition\" (cdef) box found in JP2-family data source.  Missing or invalid count field.\0"
  },
  {
    "E(jp2.cpp)", 75,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 76,
    "Error in Kakadu File Format Support:\n",
    "Malformed channel definition (cdef) box found in JP2-family data source.  The box appears to provide multiple channels with the same assocation and data format.\0"
  },
  {
    "E(jp2.cpp)", 77,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 84,
    "Error in Kakadu File Format Support:\n",
    "Malformed channel definition (cdef) box found in JP2-family data source.  The box appears to provide multiple channels with the same association and data format.\0"
  },
  {
    "E(jp2.cpp)", 85,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 97,
    "Error in Kakadu File Format Support:\n",
    "Embedded ICC profile in JP2 colour description box does not have a complete header -- or the profile may be ridiculously long!\0"
  },
  {
    "E(jp2.cpp)", 98,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 126,
    "Error in Kakadu File Format Support:\n",
    "Encountered a JP2 Header box having data which does not belong toany defined sub-box.\0"
  },
  {
    "E(jp2.cpp)", 129,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 554701573,
    "Error in Kakadu File Format Support:\n",
    "Embedded ICC profile in JP2 colour description box specifies more tags than can be accommodated by the length of the profile\0"
  },
  {
    "E(jp2.cpp)", 587797250,
    "Error in Kakadu File Format Support:\n",
    "ICC profile embedded in JP2 colour description box appears to have been truncated!\0"
  },
  {
    "E(jp2.cpp)", 604050947,
    "Error in Kakadu File Format Support:\n",
    "Malformed \"pixel format\" (pxfm) box found in JP2-family data source.  Missing or invalid count field.\0"
  },
  {
    "E(jp2.cpp)", 604050948,
    "Error in Kakadu File Format Support:\n",
    "Malformed \"pixel format\" (pxfm) box found in JP2-family data source.  The box appears to be too long.\0"
  },
  {
    "E(jp2.cpp)", 604050949,
    "Error in Kakadu File Format Support:\n",
    "Malformed \"pixel format\" (pxfm) box found in JP2-family data source.  Missing channel format description.\0"
  },
  {
    "E(jp2.cpp)", 604050950,
    "Error in Kakadu File Format Support:\n",
    "Malformed \"pixel format\" (pxfm) box found in JP2-family data source.  Invalid format code.\0"
  },
  {
    "E(jp2.cpp)", 604050951,
    "Error in Kakadu File Format Support:\n",
    "Malformed \"pixel format\" (pxfm) box found in JP2-family data source.  Number of channels described is too small to accommodate those referenced by the \"channel description\" (cdef) box.\0"
  },
  {
    "E(jp2.cpp)", 604050960,
    "Error in Kakadu File Format Support:\n",
    "Fixed-point data format identified in call to `jp2_channels::set_colour_mapping', or one of the associated mapping functions, has an invalid number of integer bits -- you may need to increase the precision of the associated codestream image component.\0"
  },
  {
    "E(jp2.cpp)", 604050961,
    "Error in Kakadu File Format Support:\n",
    "Floating-point data format identified in call to `jp2_channels::set_colour_mapping', or one of the associated mapping functions, has an invalid number of exponent bits -- you may need to increase the precision of the associated codestream image component.\0"
  },
  {
    "E(jp2.cpp)", 688260352,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    ...
    "Looks like the file contains an illegal channel definitions (cdef) box; trying to fix the problem so that content can still be rendered.\0"
  },
  {
    "W(jp2.cpp)", 369235457,
    "Warning in Kakadu File Format Support:\n",
    "The Component Mapping (cmap) and Channel Definition (cdef) boxes, or lack thereof, are insufficient to discover codestream components to associate with all colour channels.\0"
  }
};

static bool dummy_val = kdl_register_text(data,89);

#ifndef KDU_EXCLUDE_DEVELOPER_TEXT

static kdl_message_info dev_data[88] = {
  {
    "E(jp2.cpp)", 0,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 24011602,
    "Error in Kakadu File Format Support:\n",
    "Encountered both a \"JP2 Channel Definition\" (cdef) and a JPX \"Opacity\" (opct) box in the same context (usually a compositing layer header box).  These boxes provide alternate ways to describe channel mappings and are mutually exclusive.\0"
  },
  {
    "E(jp2.cpp)", 33691137,
    "Error in Kakadu File Format Support:\n",
    "Invalid or unsupported `data_format' passed to `jp2_palette::get_lut'.\0"
  },
  {
    "E(jp2.cpp)", 34672641,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 302322689,
    "Error in Kakadu File Format Support:\n",
    "Embedded ICC profile in JP2 colour description box is too large for input buffer.\0"
  },
  {
    "E(jp2.cpp)", 319099905,
    "Error in Kakadu File Format Support:\n",
    "Attempting to invoke `jp2_target::write_header' after the JP2 header has already been written.\0"
  },
  {
    "E(jp2.cpp)", 386339329,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "E(jp2.cpp)", 587273729,
    "Error in Kakadu File Format Support:\n",
    "Incompatible exponent channel mapping parameters supplied in calls to `jp2_channels::set_colour_mapping', `jp2_channels::set_opacity_mapping' or `jp2_channels:set_premult_mapping'; where two types of mapping (e.g. colour and opacity) are supplied for the same colour channel and both specify the split-exponent pixel data format, both are required to use the same mapping for the exponent part of the channel description.\0"
  },
  {
    "E(jp2.cpp)", 587273730,
    "Error in Kakadu File Format Support:\n",
    "Invalid data format/params combination supplied in call to `jp2_channels::set_colour_mapping'.\0"
  },
  {
    "E(jp2.cpp)", 587273731,
    "Error in Kakadu File Format Support:\n",
    "Invalid data format/params combination supplied in call to `jp2_channels::set_opacity_mapping'.\0"
  },
  {
    "E(jp2.cpp)", 587273732,
    "Error in Kakadu File Format Support:\n",
    "Invalid data format/params combination supplied in call to `jp2_channels::set_premult_mapping'.\0"
  },
  {
    "E(jp2.cpp)", 604050945,
    "Error in Kakadu File Format Support:\n",
    "Encountered both a \"JP2 Channel Definitions\" (cdef) and a JPX \"Opacity\" (opct) box in the same context (usually a compositing layer header box).  These boxes provide alternate ways to describe channel mappings and are mutually exclusive.\0"
  },
  {
    "E(jp2.cpp)", 604050963,
    "Error in Kakadu File Format Support:\n",
    "Attempting to write a JP2 pixel format (pxfm) box to the image header box of a baseline JP2 file.  This box type is defined by JPX, not JP2, and is required only if you specified a non-default data format in calls to `jp2_channels::set_colour_mapping', `jp2_channels::set_opacity_mapping' or `jp2_channels::set_premult_mappint'.\0"
  },
  {
    "E(jp2.cpp)", 637864193,
    "Error in Kakadu File Format Support:\n",
  ...
  },
  {
    "W(jp2.cpp)", 604050962,
    "Warning in Kakadu File Format Support:\n",
    "Unable to record chroma key supplied to `jp2_channels' object in the generated file, since this reqires an \"opacity\" (opct) box to be written in place of a \"channel definition\" (cdef) box, yet other aspects of the information supplied to `jp2_channels::set_colour_mapping' and related functions demand that a cdef box be written.  The use of chroma keys is discouraged.\0"
  }
};

static bool dev_dummy_val = kdl_register_text(dev_data,88);
