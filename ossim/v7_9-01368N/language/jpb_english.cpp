...
static kdl_message_info data[18] = {
  {
    "E(jpb.cpp)", 4,
  ...
  },
  {
    "E(jpb.cpp)", 268899585,
    "Error in Kakadu File Format Support:\n",
    "Elemetary broadcast stream super-box contains multiple `DMON' (mastering display) sub-boxes.\0"
  },
  {
    "E(jpb.cpp)", 268899586,
    "Error in Kakadu File Format Support:\n",
    "Invalid `DMON' (mastering display) sub-box encountered while parsing elementary broadcast stream.\0"
  }
};

static bool dummy_val = kdl_register_text(data,18);
