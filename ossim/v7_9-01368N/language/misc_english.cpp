...
static kdl_message_info data[27] = {
  {
    "E(args.cpp)", 0,
  ...
  {
    "E(kdu_region_compositor.cpp)", 369235461,
    "Error in Kakadu Region Compositor:\n",
    "The reference codestream image component on which rendering is to be based has no samples at all in the original codestream!\0"
  },
  {
  ...
  {
    "E(kdu_region_decompressor.cpp)", 50468353,
    "Error in Kakadu Region Decompressor:\n",
    "Attempting to force re-interpretation of integers as floating point bit patterns, where the source line buffers do not employ an absolute integer representation.  This suggests that the special \"reinterpret-as-float\" format found in a JPX pixel format (pxfm) box has been used to describe codestream samples that do not have an associated non-linear point transform of the SMAG or UMAG variety.\0"
  },
  {
    "E(kdu_region_decompressor.cpp)", 369235458,
    "Error in Kakadu Region Decompressor:\n",
    "Cannot configure channel mappings; no valid colour channel mappings are available.\0"
  },
  {
    "E(kdu_region_decompressor.cpp)", 369235459,
    "Error in Kakadu Region Decompressor:\n",
    "One or more of the codestream image components required to render the image does not exist!  The file format is most likely corrupt.\0"
  },
  {
    "E(kdu_region_decompressor.cpp)", 386012674,
    "Error in Kakadu Region Decompressor:\n",
    "One of more of the codestream image components required to render the image is entirely empty -- i.e., it has no compressed samples whatsoever!\0"
  },
  {
    "E(kdu_video_io.h)", 0,
    "Error in Kakadu File Format Support:\n",
  ...
  {
    "E(kdu_video_io.h)", 17372673,
    "Error in Kakadu File Format Support:\n",
    "Input file\0"
    "advertises a fixed compressed frame size, but does not include a non-zero size value!\0"
  },
  {
    "E(kdu_video_io.h)", 17372674,
    "Error in Kakadu File Format Support:\n",
    "If `kdu_simple_video_target::open' is called with the `KDU_SIMPLE_VIDEO_CBR' flag, a non-zero fixed frame length must be specified via a call to `kdu_simple_video_target::set_fixed_length'.\0"
  },
  {
    "E(kdu_video_io.h)", 822613505,
    "Error in Kakadu File Format Support:\n",
    "Unable to allocate sufficient memory to hold a compressed frame.  Perhaps you should not be using the simple MJC file format!\0"
  },
  {
...
static bool dummy_val = kdl_register_text(data,27);

#ifndef KDU_EXCLUDE_DEVELOPER_TEXT

static kdl_message_info dev_data[40] = {
  {
    "E(kdu_cache.cpp)", 0,
  ...
  {
    "E(kdu_region_compositor.cpp)", 50468097,
    "Error in Kakadu Region Compositor:\n",
    "Invoking `kdu_region_compositor::add_frame' without first calling `set_frame'.  Multi-frame composition must always commence with `set_frame'.\0"
  },
  {
  ...
  {
    "E(kdu_region_compositor.cpp)", 386012673,
    "Error in Kakadu Region Compositor:\n",
    "Attempting to allocate a composition buffer that is ridiculously large or ridiculously wide!  The memory sub-system might allow this, but the region-compositor is intended for rendering modest size images or regions within potentially huge images, not for rendering enormous images in one hit!  Try rendering a smaller region or rendering at a reduced scale.\0"
  },
  {
  ...
  {
    "E(kdu_region_decompressor.cpp)", 369235464,
    "Error in Kakadu Region Decompressor:\n",
    "Buffer dimensions exceed internal representation range!  You may be able to render this source at a reduced scale.\0"
  },
  {
    "E(kdu_region_decompressor.cpp)", 805377537,
    "Error in Kakadu Region Decompressor:\n",
    "Channel-mapping object passed to `kdu_region_decompressor::start' identifies a palette lookup table for some channel that is only available at low precision, yet the channel-interp record for the same channel identifies a non-trivial non-default data format (float-interpreted or fixpoint-interpreted integers with a non-trivial integer part).  These channels require a floating-point precision version of the palette lookup table -- read the documentation for `kdu_channel_mapping::float_palette'.\0"
  },
  {
  ...
  {
    "E(kdu_stripe_compressor.cpp)", 671355905,
    "Error in Kakadu Stripe Compressor:\n",
    "Attempt to open tile via `kdu_codestream::access_tile' has failed, even though the call involved a blocking wait.  Something seems to have gone wrong internally.\0"
  },
  {
  ...
  {
    "E(kdu_stripe_decompressor.cpp)", 671355905,
    "Error in Kakadu Stripe Decompressor:\n",
    "Attempt to open tile via `kdu_codestream::access_tile' has failed, even though the call involved a blocking wait.  Something seems to have gone wrong internally.\0"
  },
  {
    "E(kdu_video_io.h)", 822613506,
    "Error in Kakadu File Format Support:\n",
    "Fixed compressed frame size declared when opening MJC output file is violated during codestream generation!\0"
  }
};

static bool dev_dummy_val = kdl_register_text(dev_data,40);
