...
static kdl_message_info data[77] = {
  {
    "E(kdu_client.cpp)", 1,
  ...
  },
  {
    "E(kdu_client.cpp)", 29,
    "Error in Kakadu Client:\n",
    "Server appears to have issued a new unique target identifier, while we were in the middle of browsing the image.  Most likely, the image has been modified on the server and you should re-open it from scratch.\0"
  },
  {
    "E(kdu_client.cpp)", 30,
    "Error in Kakadu Client:\n",
  ...
  {
    "E(kdu_client.cpp)", 419566849,
    "Error in Kakadu Client:\n",
    "The identifying TARGET-ID appears to have changed at the server end.  To access the server's version of this source, you will need to close and connect from scratch.\0"
  },
  {
...
static bool dummy_val = kdl_register_text(data,77);
